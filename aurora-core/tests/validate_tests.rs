use aurora_core::ast::{IndexKind, SchemaItem};
use aurora_core::{AuroraError, parse_validated};

fn extract_table(schema: &aurora_core::Schema, name: &str) -> aurora_core::ast::Table {
    schema
        .items
        .iter()
