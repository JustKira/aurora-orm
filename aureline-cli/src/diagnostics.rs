...
use anyhow::Result;
use aureline_core::{Diagnostic, Severity, SourcePosition, SourceRange};
...
mod tests {
    ...
    use aureline_core::{Diagnostic, DiagnosticCode, Severity, SourcePosition, SourceRange};
    ...
    fn renders_diagnostic_with_source_snippet() {
        ...
        assert!(rendered.contains("--> schema.aureline:2:16"));
