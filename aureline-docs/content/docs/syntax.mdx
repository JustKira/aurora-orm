---
title: Schema Syntax
description: Aureline schema syntax, supported declarations, attributes, and SurrealQL equivalents.
icon: Braces
---

Aureline schema files describe the SurrealDB schema that Aureline can parse, validate, and emit today.
