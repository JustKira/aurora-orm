...
// Tree-sitter grammar for the Aureline schema language. Mirrors the pest grammar
// at tools/aureline-core/src/aureline.pest — anything that parses there should
// parse here.
...
module.exports = grammar({
  ...
  rules: {
    ...
    // (in aureline-core) is the rule book. This keeps the grammar tiny and lets
